...
export default function UPVoteSVG(props) {
    ...
    const [increaseOrNot, setIncrease] = useState(true)
    ...
    return (
        <svg width={props.size} height={props.size} viewBox="0 0 24 24" fill={fillColor} xmlns="http://www.w3.org/2000/svg" onClick={handleSVGClick} increase={increaseOrNot}>
