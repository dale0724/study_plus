        ...
        return (
            <div className={`mt-3 ${styles.border}`} >
                <form onSubmit={this.handleSubmit}>
                    <Row>
                        <input type="text" name="searchText" style={{width:"50%", borderRadius:"0.25rem", borderColor:"#395075"}} value={this.state.searchText} onChange={this.handleChange} placeholder={"search announcements..."}/>
                                        ...
                                        <Button  id={item.id} style={{backgroundColor:"#c5d3e6", borderColor: "#000000", padding: "2px", marginRight: "0.25rem"}} onClick={this.handleTagRemove}>
                                            <div>
                                                <div className={styles.leftPanel}>
                                                    <span style={{color:"#395075", alignSelf:"center"}}>{item.value}</span>
                                                </div>
                                                <div className={styles.rightPanel}>
                                                    <CrossSvg fill="#395075"/>
                                                </div>
                                            </div>
                                        </Button>
                                    </React.Fragment>
                    ...
                    <Row>
                        <div className={styles.searchTagsResultContainer}>
                            <Button value="EE4717" style={{backgroundColor:"#d8e0eb", borderColor: "#000000", padding:"2px", marginRight:"0.25rem"}} onClick={this.handleTagAdd}>
                                <div>
                                    <div className={styles.leftPanel}>
                                        <span style={{color:"#395075", fontSize:"15px", alignSelf:"center"}}>EE4717</span>
                                    </div>
                                    <div className={styles.rightPanel}>
                                        <span style={{color:"#395075", fontSize:"15px", alignSelf:"center"}}>20</span>
                                    </div>
                                </div>
                            </Button>
                            <Button value="quiz" style={{backgroundColor:"#d8e0eb", borderColor: "#000000", padding:"2px", marginRight:"0.25rem"}} onClick={this.handleTagAdd}>
                                <div>
                                    <div className={styles.leftPanel}>
                                        <span style={{color:"#395075", fontSize:"15px", alignSelf:"center"}}>quiz</span>
                                    </div>
                                    <div className={styles.rightPanel}>
                                        <span style={{color:"#395075", fontSize:"15px", alignSelf:"center"}}>18</span>
                                    </div>
                                </div>
                            </Button>
                            <Button value="Exam" style={{backgroundColor:"#d8e0eb", borderColor: "#000000", padding:"2px", marginRight:"0.25rem"}} onClick={this.handleTagAdd}>
                                <div>
                                    <div className={styles.leftPanel}>
                                        <span style={{color:"#395075", fontSize:"15px", alignSelf:"center"}}>Exam</span>
                                    </div>
                                    <div className={styles.rightPanel}>
                                        <span style={{color:"#395075", fontSize:"15px", alignSelf:"center"}}>25</span>
                                    </div>
                                </div>
                            </Button>
                        </div>
